...
function switchView(mode) {
    const gridView = document.querySelector('.incident-grid-new');
    const tableView = document.querySelector('.list-view-new');
    
    // Buttons
    const btnGrid = document.querySelector('.view-btn[onclick*="grid"]');
    const btnList = document.querySelector('.view-btn[onclick*="list"]');
